...
//  SmartGame
//
//  Created by Paw.toporkov on 13/02/2020.
...
class MyTimer: UIView
{
    ...
    @IBInspectable public var backGroundCircleColor: UIColor = UIColor.green
    ...
    override func draw(_ rect: CGRect)
    {
      ...
      let lineWidth = 0.9 * min(width, height)
